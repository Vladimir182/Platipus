...
export namespace GamificationDynamicFieldSet {
...
export class GamificationDynamicFieldSet extends React.Component<GamificationDynamicFieldSet.Props, any> {
  ...
  render() {
    ...
    return (
      <div>
        {
          this.props.prizes.map((col: any, index: number) => {
            return(
            <Item key={index} required={col.required} className="gutter-box">
              <div className='gamification-wrap-field'>
                  ...
                  <Col span={20}>
                  {
                    ...
                    { this.props.prizes.length === 1 ? '' :
                      (<Col span={4} style={styles}>
                        <a onClick={(e: any)=>{this.setDelete(index)}} className='gamification-prize-delete-row'>
